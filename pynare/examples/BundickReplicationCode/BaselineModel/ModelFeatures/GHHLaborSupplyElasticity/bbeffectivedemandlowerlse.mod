...
ylim([-0.2 0.2]);set(gca,'YTick',[-0.2:0.1:0.2],'FontSize',12);ylabel('Percent','FontSize',12)
legend(sprintf('Flexible Prices\nNo Wealth Effect Labor Supply'),sprintf('Baseline Model'),sprintf('Sticky Prices\nNo Wealth Effect Labor Supply'),sprintf('Sticky Prices\nLower Labor Supply Elasticity'),'Location','NorthEast')
...
print('-dpdf',['GHHLaborSupplyElasticity.pdf'])
