...
subplot(2,3,1)
hold on
plot(t,100*IRpoint(:,2,1),'-','Color','k','LineWidth',3)
...
subplot(2,3,2)
hold on
plot(t,100*IRpoint(:,3,1),'-','Color','k','LineWidth',3)
...
subplot(2,3,3)
hold on
plot(t,100*IRpoint(:,4,1),'-','Color','k','LineWidth',3)
...
subplot(2,3,4)
hold on
plot(t,100*IRpoint(:,5,1),'-','Color','k','LineWidth',3)
title('Hours','FontSize',16);xlim([t(1) t(end)]);set(gca,'XTick',t(4:4:end),'FontSize',12);
ylim([-0.4 0.4]);set(gca,'YTick',[-0.4:0.2:0.4],'FontSize',12);ylabel('Percent','FontSize',12)

subplot(2,3,5)
hold on
plot(t,100*IRpoint(:,1,1),'-','Color','k','LineWidth',3)
