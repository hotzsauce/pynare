...
stoch_simul(order=3,periods=1000,irf=0,noprint,nograph,nomoments,nofunctions,nocorr,pruning);
...
subplot(3,3,1)
hold on
plot(t,100*y_evola./y_sss,'-','Color','b','LineWidth',3)
...
subplot(3,3,2)
hold on
plot(t,100*c_evola./c_sss,'-','Color','b','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(3,3,3)
hold on
plot(t,100*inv_evola./inv_sss,'-','Color','b','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(3,3,4)
hold on
plot(t,100*mu_evola./mu_sss,'-','Color','b','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(3,3,5)
hold on
plot(t,100*n_evola./n_sss,'-','Color','b','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(3,3,6)
hold on
plot(t,100*w_evola./w_sss,'-','Color','b','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(3,3,7)
hold on
plot(t,100*u_evola./u_sss,'-','Color','b','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
title('Utilization','FontSize',16);xlim([t(1) t(end)]);set(gca,'XTick',t(4:4:end),'FontSize',12);
...
subplot(3,3,8)
hold on
plot(t,400*pie_evola,'-','Color','b','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
title('Inflation','FontSize',16);xlim([t(1) t(end)]);set(gca,'XTick',t(4:4:end),'FontSize',12);
%ylim([-0.2 0.1]);set(gca,'YTick',[-0.2:0.1:0.1],'FontSize',12);ylabel('Percentage Points','FontSize',12)

figure(1)
subplot(3,3,9)
hold on
plot(t,100*vola_evola./vola_sss,'-','Color','b','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
title('Preference Shock Volatility','FontSize',16);xlim([t(1) t(end)]);set(gca,'XTick',t(4:4:end),'FontSize',12);
%ylim([0 60]);set(gca,'YTick',[0:10:60],'FontSize',12);ylabel('Percent','FontSize',12)
