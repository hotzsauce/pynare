...
%% DEFINE VARIABLES
vardata = [logvix logoutput logconsumption loginvestment loghours logprices logm2 shadowrate];
...
ylim([-0.6 0.4]);set(gca,'YTick',[-0.6:0.2:0.4],'FontSize',12);ylabel('Percentage Points','FontSize',12)
...
print('-dpdf',['MeasureUncertaintyVIX.pdf'])
