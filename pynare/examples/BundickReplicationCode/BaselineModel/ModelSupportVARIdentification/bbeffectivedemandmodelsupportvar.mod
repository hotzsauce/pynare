...
subplot(2,3,1)
hold on
plot(t,100*inv_evola./inv_sss,'o','MarkerEdgeColor','k','MarkerFaceColor','k','MarkerSize',7)
plot(t,100*inv_ea./inv_sss,'-','Color','b','LineWidth',3)
plot(t,-100*inv_ez./inv_sss,'--','Color','r','LineWidth',3)
...
ylim([-2 1]);set(gca,'YTick',[-2:0.5:1],'FontSize',12);ylabel('Percent','FontSize',12)

figure(1)
subplot(2,3,2)
hold on
plot(t,100*pe_evola./pe_sss,'o','MarkerEdgeColor','k','MarkerFaceColor','k','MarkerSize',7)
plot(t,100*pe_ea./pe_sss,'-','Color','b','LineWidth',3)
plot(t,-100*pe_ez./pe_sss,'--','Color','r','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
title('Price of Equity','FontSize',16);xlim([t(1) t(end)]);set(gca,'XTick',t(4:4:end),'FontSize',12);
ylim([-2 1]);set(gca,'YTick',[-2:0.5:1],'FontSize',12);ylabel('Percent','FontSize',12)
...
plot(t,100*logvxo_ea,'-','Color','b','LineWidth',3)
plot(t,-100*logvxo_ez,'--','Color','r','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
legend('2nd-Moment Preference','1st-Moment Preference','1st-Moment Technology','Location','NorthEast')
...
print('-dpdf',['ModelSupportVARIdentification.pdf'])
