...
class Interpreter(ABCVisitor):
	...
	the AlgebraParser. For the moment, _GLOBAL_SCOPE is just a dictionary. 

	This is not meant to be used as a top-level intepreter, because variable 
	assignment is handled by another sub-classed interprter
	"""
