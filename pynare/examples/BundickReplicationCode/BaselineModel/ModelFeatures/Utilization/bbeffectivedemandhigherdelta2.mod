...
subplot(2,3,1)
hold on
plot(t,100*y_evola./y_sss,'r--','LineWidth',3)
...
subplot(2,3,2)
hold on
plot(t,100*c_evola./c_sss,'r--','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(2,3,3)
hold on
plot(t,100*inv_evola./inv_sss,'r--','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(2,3,4)
hold on
plot(t,100*mu_evola./mu_sss,'r--','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(2,3,5)
hold on
plot(t,100*n_evola./n_sss,'r--','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(2,3,6)
hold on
plot(t,100*w_evola./w_sss,'r--','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
title('Real Wage','FontSize',16);xlim([t(1) t(end)]);set(gca,'XTick',t(4:4:end),'FontSize',12);
ylim([-0.2 0.2]);set(gca,'YTick',[-0.2:0.1:0.2],'FontSize',12);ylabel('Percent','FontSize',12)
legend('Baseline Model','Larger \delta_{2}','Baseline','Location','NorthEast')
