...
subplot(3,3,1)
hold on
plot(t,100*y_evolz./y_sss,'--','Color','r','LineWidth',3)
...
subplot(3,3,2)
hold on
plot(t,100*c_evolz./c_sss,'--','Color','r','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(3,3,3)
hold on
plot(t,100*inv_evolz./inv_sss,'--','Color','r','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(3,3,4)
hold on
plot(t,100*mu_evolz./mu_sss,'--','Color','r','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(3,3,5)
hold on
plot(t,100*n_evolz./n_sss,'--','Color','r','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(3,3,6)
hold on
plot(t,100*w_evolz./w_sss,'--','Color','r','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(3,3,7)
hold on
plot(t,400*rr_evolz,'--','Color','r','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(3,3,8)
hold on
plot(t,100*volz_evolz./volz_sss,'--','Color','r','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
title('Shock Volatility','FontSize',16);xlim([t(1) t(end)]);set(gca,'XTick',t(4:4:end),'FontSize',12);
legend(sprintf('2nd-Moment Preference Shock\nBaseline Model'),sprintf('2nd-Moment Preference Shock\nCountercyclical Markups\nNo Nominal Rigidities'),...
	   sprintf('2nd-Moment Technology Shock'),'Location','NorthEast')
...
print('-dpdf',['RealMUsTechnologyUncertainty.pdf'])
