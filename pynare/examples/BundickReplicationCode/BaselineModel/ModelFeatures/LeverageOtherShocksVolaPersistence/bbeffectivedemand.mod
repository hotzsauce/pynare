...
subplot(2,3,1)
hold on
plot(t,100*y_evola./y_sss,'o','MarkerEdgeColor','k','MarkerFaceColor','k','MarkerSize',7)
...
subplot(2,3,2)
hold on
plot(t,100*c_evola./c_sss,'o','MarkerEdgeColor','k','MarkerFaceColor','k','MarkerSize',7)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(2,3,4)
hold on
plot(t,100*n_evola./n_sss,'o','MarkerEdgeColor','k','MarkerFaceColor','k','MarkerSize',7)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
legend('Higher Leverage',sprintf('Higher Unconditional\nTechnology Shock Volatility'),'IID Uncertainty Shock','Baseline','Location','NorthEast')
...
print('-dpdf',['LeverageOtherShocksVolaPersistence.pdf'])
