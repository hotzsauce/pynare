...
for i = 1:nperiods
   ...
   if i == 1
        ...
        if i == shockperiod
        	...
        	epsilonashock(i,1) = 1;%/(100*lagvolashock(i,1));
...
plot(t,ushockbaselinedeviation(shockperiod:nperiods,1),'r--','LineWidth',3)
title('Utilization','FontSize',16);xlim([t(1) t(end)]);set(gca,'XTick',t(4:4:end),'FontSize',12);ylabel('Percent','FontSize',12)
