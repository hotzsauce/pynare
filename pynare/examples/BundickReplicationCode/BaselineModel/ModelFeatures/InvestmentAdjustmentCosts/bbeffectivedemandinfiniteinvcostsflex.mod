...
subplot(3,3,1)
hold on
plot(t,100*y_evola./y_sss,':','Color','k','LineWidth',4)
...
ylim([-0.4 0.2]);set(gca,'YTick',[-0.4:0.1:0.2],'FontSize',12);ylabel('Percent','FontSize',12)


figure(1)
subplot(3,3,2)
hold on
plot(t,100*c_evola./c_sss,':','Color','k','LineWidth',4)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
title('Consumption','FontSize',16);xlim([t(1) t(end)]);set(gca,'XTick',t(4:4:end),'FontSize',12);
ylim([-0.4 0.1]);set(gca,'YTick',[-0.4:0.1:0.1],'FontSize',12);ylabel('Percent','FontSize',12)

figure(1)
subplot(3,3,3)
hold on
plot(t,100*inv_evola./inv_sss,':','Color','k','LineWidth',4)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(3,3,4)
hold on
plot(t,100*mu_evola./mu_sss,':','Color','k','LineWidth',4)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
title('Markup','FontSize',16);xlim([t(1) t(end)]);set(gca,'XTick',t(4:4:end),'FontSize',12);
ylim([-0.2 0.8]);set(gca,'YTick',[-0.2:0.2:0.8],'FontSize',12);ylabel('Percent','FontSize',12)


figure(1)
subplot(3,3,5)
hold on
plot(t,100*n_evola./n_sss,':','Color','k','LineWidth',4)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
title('Hours Worked','FontSize',16);xlim([t(1) t(end)]);set(gca,'XTick',t(4:4:end),'FontSize',12);
ylim([-0.4 0.2]);set(gca,'YTick',[-0.4:0.2:0.2],'FontSize',12);ylabel('Percent','FontSize',12)


figure(1)
subplot(3,3,6)
hold on
plot(t,100*w_evola./w_sss,':','Color','k','LineWidth',4)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
title('Real Wage','FontSize',16);xlim([t(1) t(end)]);set(gca,'XTick',t(4:4:end),'FontSize',12);
ylim([-0.6 0.2]);set(gca,'YTick',[-0.6:0.2:0.2],'FontSize',12);ylabel('Percent','FontSize',12)


figure(1)
subplot(3,3,7)
hold on
plot(t,400*rr_evola,':','Color','k','LineWidth',4)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
title('Real Interest Rate','FontSize',16);xlim([t(1) t(end)]);set(gca,'XTick',t(4:4:end),'FontSize',12);
ylim([-1.0 0.2]);set(gca,'YTick',[-1.0:0.2:0.2],'FontSize',12);ylabel('Percentage Points','FontSize',12)


figure(1)
subplot(3,3,8)
hold on
plot(t,400*pie_evola,':','Color','k','LineWidth',4)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
title('Inflation','FontSize',16);xlim([t(1) t(end)]);set(gca,'XTick',t(4:4:end),'FontSize',12);
ylim([-1.0 0.2]);set(gca,'YTick',[-1.0:0.2:0.2],'FontSize',12);ylabel('Percentage Points','FontSize',12)

figure(1)
subplot(3,3,9)
hold on
plot(t,100*vola_evola./vola_sss,':','Color','k','LineWidth',4)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
title('Preference Shock Volatility','FontSize',16);xlim([t(1) t(end)]);set(gca,'XTick',t(4:4:end),'FontSize',12);
ylim([0 120]);set(gca,'YTick',[0:20:120],'FontSize',12);ylabel('Percent','FontSize',12)
legend('Baseline Model','\phi_{K} = 0','\phi_{K} = \infty, \delta_{2} = \infty','\phi_{K} = \infty, \delta_{2} = \infty, \phi_{P} = 0','Location','NorthWest')

set(gcf, 'PaperPositionMode', 'manual');
set(gcf, 'PaperUnits', 'inches');
set(gcf, 'PaperOrientation', 'portrait');
set(gcf, 'PaperPosition', [-0.5 -0.75 9.5 12.0]);
print('-dpdf',['InvestmentAdjustmentCosts.pdf'])
