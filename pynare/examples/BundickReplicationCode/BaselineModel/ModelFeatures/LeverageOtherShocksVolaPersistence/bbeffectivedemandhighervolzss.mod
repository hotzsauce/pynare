...
subplot(2,3,1)
hold on
plot(t,100*y_evola./y_sss,'s','MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',9)
...
subplot(2,3,2)
hold on
plot(t,100*c_evola./c_sss,'s','MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',9)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(2,3,3)
hold on
plot(t,100*inv_evola./inv_sss,'s','MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',9)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(2,3,4)
hold on
plot(t,100*n_evola./n_sss,'s','MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',9)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(2,3,5)
hold on
plot(t,100*logvxo_evola,'s','MarkerEdgeColor','r','MarkerFaceColor','r','MarkerSize',9)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
