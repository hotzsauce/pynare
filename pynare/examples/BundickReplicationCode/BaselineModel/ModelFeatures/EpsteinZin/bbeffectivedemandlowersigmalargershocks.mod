...
subplot(3,3,6)
hold on
plot(t,100*w_evola./w_sss,'--','Color','r','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
title('Real Wage','FontSize',16);xlim([t(1) t(end)]);set(gca,'XTick',t(4:4:end),'FontSize',12);
ylim([-0.3 0.1]);set(gca,'YTick',[-0.3:0.1:0.1],'FontSize',12);ylabel('Percent','FontSize',12)


figure(1)
subplot(3,3,7)
hold on
plot(t,400*rr_evola,'--','Color','r','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(3,3,8)
hold on
plot(t,400*pie_evola,'--','Color','r','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
subplot(3,3,9)
hold on
plot(t,100*vola_evola./vola_sss,'--','Color','r','LineWidth',3)
plot(zeros(irflength,1),'k--','HandleVisibility','off'); xlim([0 irflength]);set(gca,'XTick',[4:4:irflength],'FontSize',12);
...
legend('Baseline Model','Lower Risk Aversion',sprintf('Lower Risk Aversion\n & Larger Shocks'),'Location','NorthWest')

set(gcf, 'PaperPositionMode', 'manual');
set(gcf, 'PaperUnits', 'inches');
set(gcf, 'PaperOrientation', 'portrait');
set(gcf, 'PaperPosition', [-0.5 -0.75 9.5 12.0]);
print('-dpdf',['EpsteinZinPreferences.pdf'])
